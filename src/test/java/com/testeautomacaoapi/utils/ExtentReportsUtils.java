...
public class ExtentReportsUtils {
    ...
    public static void addTestInfo(String url, Map<String, String> headers, Map<String, String> cookies, String xmlBody, String authenticatorUser, String authenticatorPassword, Response response){
        String allHeaders = "";
        String allCookies = "";
        String allResponseHeaders = "";
